...
namespace Buytopia.Areas.Customer.Controllers
{
    ...
    public class SubCategoryController : Controller
    {
        ...
        {
            var subCategories = await _db.SubCategorie.Include(s => s.Category).ToListAsync();
        ...
        public async Task<IActionResult> Create()
        {
            SubCategoryAndCategoryViewModel model = new SubCategoryAndCategoryViewModel()
            {
                ...
                SubCategoryList = await _db.SubCategorie.OrderBy(p => p.Name).Select(p => p.Name).Distinct().ToListAsync()
            };
        ...
        public async Task<IActionResult> Create(SubCategoryAndCategoryViewModel model)
        {
            ...
            {
                // Fache the name from subcategory if exist using iger loading
                var doesSubCategoryExists = _db.SubCategorie.Include(s => s.Category).Where(s => s.Name == model.SubCategory.Name && s.Category.Id == model.SubCategory.CategoryId);
         ...
         public async Task<IActionResult> Edit(int? id)
          {
                  if (id == null)
                    ...
                    var subCategory = await _db.SubCategorie.SingleOrDefaultAsync(m => m.Id == id);
                ...
                public async Task<IActionResult> Edit(SubCategoryAndCategoryViewModel model)
                {
                    ...
                    return View(modelVM);
                        ...
                        public async Task<IActionResult> Details(int? id)
                        {
                            ...
                            var subCategory = await _db.SubCategorie.Include(s => s.Category).SingleOrDefaultAsync(m => m.Id == id);
                            if (subCategory == null)
                            {
                                return NotFound();
                            }
